<template>
	<view class="head_bg">
		<view class="flex flex-column align-center justify-center" style="height: 30%;">
			<view style="font-size: 50rpx;font-weight: 700;"> 注销账号</view>
		...
		<view class="chushi_shuru" >
			...
			<view  v-show="login_manner_is" class="huoqu_yanzheng flex justify-center align-center" style="color: white;" >
				<view v-if="is_yanzheng" @click="huoqu_yanzheng" style="width: 80%;">获取验证</view>
		...
		<button class="chushi_denglu" style="color: white; font-size: 30rpx;margin-top: 5%;" @click="denglu" :loading="loading" >{{this.loading ? '验证中...':'注销'}}</button>
	</view>
</template>
